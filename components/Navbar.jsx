    ...
    <div className='w-full h-[10vh] py-2 z-10 flex justify-between items-center px-10'>
      ...
      {userdetails?.username === undefined ? <div className='flex gap-2'>
        ...
        <span className='flex gap-14 items-center relative  font-medium '>
          <Link href={'/weather'} className='hover:text-blue-400 cursor-pointer transition-all duration-100 hover:scale-[0.95]'>Weather Forecast</Link>
          <Link href={'/prediction'} className='hover:text-blue-400 cursor-pointer transition-all duration-100 hover:scale-[0.95]'>Prediction</Link>
          ...
          <span className='flex gap-2 items-center text-black'>welcome, <span className='font-medium '>{userdetails.username}</span> <span ref={showref}>
